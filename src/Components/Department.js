          ...
          <tbody>
            {this.state.deps.map(dept=>
               <tr key={dept.DepartmentID}>
                   ...
                   <ButtonToolbar>
                        <Button 
                            onClick={()=>this.setState({editModalShow:true,depid:dept.DepartmentID,depname:dept.DepartmentName})}          
                            >Edit
                        </Button>
                    <EditDeptModal deptID={this.state.depid} deptName={this.state.depname}
                      IsAdd={false}  show={this.state.editModalShow} 
